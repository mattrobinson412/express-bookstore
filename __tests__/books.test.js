...
const app = require("../../../../Solutions/Node.js/express-bookstore-solution/app");
const db = require("../../../../Solutions/Node.js/express-bookstore-solution/db");
...
describe("PUT /books/:id", async function () {
  test("Updates a single book", async function () {
    ...
    expect(response.body.book).toHaveProperty("isbn");
    expect(response.body.book.title).toBe("UPDATED BOI");
  });
